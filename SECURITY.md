...
Symfony Doctrine Encrypt follows [Semantic Versioning](https://semver.org/spec/v2.0.0.html). The latest stable major line is actively maintained and receives security fixes.

| Version | Status              | Security fixes |
|---------|---------------------|----------------|
| 4.x     | Actively maintained | Yes            |
| < 4.0   | End of life         | No             |
...
- The affected version and tag/commit.
...
- We aim to confirm the issue, prepare a fix, and ship a release on the supported major line.
